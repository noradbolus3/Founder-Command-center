...
public class MainActivity extends android.app.Activity {
    ...
    private LinearLayout section(String title, String action) { LinearLayout holder = row(); holder.setGravity(Gravity.CENTER_VERTICAL); TextView t = text(title, 17, TEXT, true); holder.addView(t, new LinearLayout.LayoutParams(0, dp(32), 1)); if (action != null) holder.addView(text(action, 11, GOLD, true)); return holder; }
